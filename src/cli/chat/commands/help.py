...
try:
    from cli.chat.commands.help_text import TOOL_COMMANDS_HELP
except ImportError:
    TOOL_COMMANDS_HELP = """
    ## Tool Commands
...
async def cmd_help(cmd_parts: List[str], context: Dict[str, Any]) -> bool:
    ...
    if len(cmd_parts) > 1:
        ...
        from cli.chat.commands import _COMMAND_HANDLERS
        ...
        if specific_cmd in _COMMAND_HANDLERS:
            ...
            from cli.chat.commands import _COMMAND_COMPLETIONS
